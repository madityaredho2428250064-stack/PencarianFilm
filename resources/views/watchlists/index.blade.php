@extends('layouts.app')
@section('content')
<div style="background: linear-gradient(135deg, #0f0f1a 0%, #1a1130 100%); min-height: 100vh;" class="py-8">
...
<div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden shadow">
...
<p class="text-gray-400 text-sm">{{ $item->movie->genres->pluck('name')->join(', ') ?: '-' }}</p>
